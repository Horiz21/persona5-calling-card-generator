...
namespace P5CCG
{
    public partial class Persona5StyleButton : UserControl
    { 
        public static readonly StyledProperty<Bitmap> DefaultImageProperty =
            AvaloniaProperty.Register<Persona5StyleButton, Bitmap>(nameof(DefaultImage));

        public static readonly StyledProperty<Bitmap> HoverImageProperty =
            AvaloniaProperty.Register<Persona5StyleButton, Bitmap>(nameof(HoverImage));

        public static readonly StyledProperty<Bitmap> PressedImageProperty =
            AvaloniaProperty.Register<Persona5StyleButton, Bitmap>(nameof(PressedImage));

        public static readonly StyledProperty<string> ControlTextContentProperty =
            AvaloniaProperty.Register<Persona5StyleButton, string>(nameof(ControlTextContent));
        ...
        private void OnPointerPressed(object sender, PointerPressedEventArgs e) => UpdateAppearance(ButtonState.Pressed);
